...
import 'package:works_flutter/ui/setting/provider.dart';
...
class SettingPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final state = useProvider(settingProvider);
    useEffect(() {}, const []);
  ...
  Widget _buildContent() {
    final action = useContext().read(settingProvider.notifier);
